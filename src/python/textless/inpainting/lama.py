...
"""LaMa inpainting models (MPE and Large variants)."""
...
from .base import OfflineInpainter
...
class LamaMPEInpainter(OfflineInpainter):
    """LaMa inpainter with Masked Positional Encoding.
...
class LamaLargeInpainter(LamaMPEInpainter):
    """LaMa Large (512px) inpainter — primary production model."""
...
def load_lama_mpe(model_path: str, device: str, use_mpe: bool = True, large_arch: bool = False) -> LamaFourier:
